...
from evaluate_stereo import (validate_things, validate_kitti15, validate_eth3d,
                             ...
                             inference_stereo, validate_inclement,
                             )
...
def get_args_parser():
    ...
    # validation: due to model use the same data as the validation and for testing, 
    # we just need to set the validation dataset to inclement
    parser.add_argument('--val_dataset', default=['inclement'], type=str, nargs='+')
...
def main(args):
    ...
    params_ratio = num_params / tot_params
    if print_info:
        #print('=> Number of trainable parameters: %d' % num_params)
        print(f'=> Number of trainable parameters: {num_params} / {tot_params} ({params_ratio * 100:.2f}%)')
